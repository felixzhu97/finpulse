...
- [ ] 引入数据库迁移（如 Alembic）；做 schema 版本管理并与 `docs/zh/data/er-diagram` 一致。
...
- [ ] 将数据分级、访问控制与留存策略与合规要求对齐，并在 `docs/zh/rd/togaf` 及安全相关文档中加以说明。

## 安全

- [ ] 明确安全架构（认证、授权、密钥管理、网络边界等），并在 `docs/zh/rd/togaf` 及相关 C4 图中记录。
...
- [ ] 新增或变更 AI 能力时，保持 `docs/zh/product/domain` 与 `docs/zh/rd/togaf/README.md, docs/zh/rd/c4/README.md` AI 小节及本 TODO 一致。

## 流程与开发体验

- [ ] 定义轻量发布检查清单，引用本 TODO 与架构文档。
- [ ] 重要架构变更时：更新 PlantUML、`docs/zh/rd/togaf/README.md, docs/zh/rd/c4/README.md` 及本 `docs/TODO.md`。
- [ ] 为主要应用与服务添加简短的“上手”指南。

---

**说明**：重大发布前请结合 `docs/zh/rd/togaf, docs/zh/rd/c4` 审阅并更新中英文 TODO。
